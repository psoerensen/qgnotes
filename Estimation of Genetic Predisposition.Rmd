...
The goal of the BLUP analysis is to estimate the fixed effects, $b$, and random genetic effects, $a$, in the linear mixed model specified above. This can be done using the BLUE and BLUP equations shown below.
